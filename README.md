...
#### transaction_amount_in_rub и transactions_in_rub
...
transaction_amount_in_rub - Функция, которая выводит одну транзакцию в рублях
transactions_in_rub - Функция преобразует транзакции в рубли, учитывая курсы валют.
### external_api
#### converter_to_ruble
Внешний API для получения текущего курса валют и конвертации суммы операции в рубли. 
...
Проверяет возврат правильной функции
#### test_unsuccessful_request
Обработка ошибки
### test_utils
#### test_successful_loading
При успешном чтении данных
#### test_file_not_found_error
Тестирование ошибки отсутствия файла
